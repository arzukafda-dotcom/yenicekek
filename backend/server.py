...
async def seed_database():
    ...
    # Categories
    categories_data = [
        {"id": str(uuid.uuid4()), "name": "Güller", "slug": "gul", "description": "Aşkın en klasik hali", "icon": "🌹"},
        {"id": str(uuid.uuid4()), "name": "Orkideler", "slug": "orkide", "description": "Şık, zarif ve kalıcı hediye", "icon": "🌸"},
        {"id": str(uuid.uuid4()), "name": "Tasarım", "slug": "tasarim", "description": "Özel aranjmanlar ve butik işler", "icon": "💐"},
        ...
        {"id": str(uuid.uuid4()), "name": "Çiçek Sepeti", "slug": "cicek-sepeti", "description": "Özel sepet aranjmanları", "icon": "🧺"},
